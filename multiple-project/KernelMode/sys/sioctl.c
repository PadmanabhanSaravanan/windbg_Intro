...

{
    ...
    case IOCTL_SIOCTL_SIMPLE_CRASH:
        SIOCTL_KDPRINT(("Called IOCTL_SIOCTL_SIMPLE_CRASH\n"));
        SimpleCrash();
        break;

    case IOCTL_SIOCTL_STACK_CORRUPTION:
        SIOCTL_KDPRINT(("Called IOCTL_SIOCTL_STACK_CORRUPTION\n"));
        StackCorruption();
        break;

    case IOCTL_SIOCTL_STACK_OVERFLOW:
        SIOCTL_KDPRINT(("Called IOCTL_SIOCTL_STACK_OVERFLOW\n"));
        StackOverflow();
        break;

    case IOCTL_SIOCTL_POOL_CURRUPTION:
        SIOCTL_KDPRINT(("Called IOCTL_SIOCTL_POOL_CURRUPTION\n"));
        PoolCorruption();
        break;


    case IOCTL_SIOCTL_KERNEL_HANG:
        SIOCTL_KDPRINT(("Called IOCTL_SIOCTL_KERNEL_HANG\n"));
        KernelHang();
        break;

    case IOCTL_SIOCTL_SYSTEM_SLOWNESS:
        SIOCTL_KDPRINT(("Called IOCTL_SIOCTL_SYSTEM_SLOWNESS\n"));
        SystemSlowness();
        break;

    case IOCTL_SIOCTL_KERNEMODE_HIGHCPU:
        SIOCTL_KDPRINT(("Called IOCTL_SIOCTL_KERNEMODE_HIGHCPU\n"));
        KernelModeHighCpu();
        break;

    case IOCTL_SIOCTL_KERNELMODE_MEMORYLEAK:
        SIOCTL_KDPRINT(("Called IOCTL_SIOCTL_KERNELMODE_MEMORYLEAK\n"));
        KernelModeMemoryLeak();
        break;

    case IOCTL_SIOCTL_ERESOURCE_LOCKS_HANG:
        SIOCTL_KDPRINT(("Called IOCTL_SIOCTL_ERESOURCE_LOCKS_HANG\n"));
        EresourceLocksHang();
        break;

    case IOCTL_SIOCTL_SPINLOCK_DEADLOCK:
        SIOCTL_KDPRINT(("Called IOCTL_SIOCTL_SPINLOCK_DEADLOCK\n"));
        SpinlockDeadlock();
        break;

    case IOCTL_SIOCTL_PENDING_IRP:
        SIOCTL_KDPRINT(("Called IOCTL_SIOCTL_PENDING_IRP\n"));
        WaitingForIrp();
        break;
